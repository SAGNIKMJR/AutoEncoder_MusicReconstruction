...
def run_training(train_subset, cv_subset, test_subset, model,
    ...
    for step in xrange(max_steps):
      ...
      # print('batch shape:{}'.format(type(data_batch)))
...
TRAIN_CV_TEST_RATIO = [0.5, 0.5, 0.0]                                               # needs to be changed
...
''' needs to be changed '''
MODEL=  CAE # basic_convnet                                                          # changed
...
''' needs to be changed '''
OPTIMIZER_FN = 'optim.Adam'                                                          # changed
